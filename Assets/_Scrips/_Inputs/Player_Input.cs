...
public class @Player_Inp : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Pause"",
                    ""type"": ""Button"",
                    ""id"": ""a3c63c65-9e9c-4c53-abb4-0de3c47f7f4d"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""cf6b0698-92cf-4802-851f-3a8f8f1888a4"",
    ...
    ""controlSchemes"": []
        ...
        m_Inp_Pause = m_Inp.FindAction("Pause", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Inp_Pause;
    public struct InpActions
    {
        ...
        public InputAction @Pause => m_Wrapper.m_Inp_Pause;
        ...
        public void SetCallbacks(IInpActions instance)
        {
            if (m_Wrapper.m_InpActionsCallbackInterface != null)
            {
                ...
                @Pause.started -= m_Wrapper.m_InpActionsCallbackInterface.OnPause;
                @Pause.performed -= m_Wrapper.m_InpActionsCallbackInterface.OnPause;
                @Pause.canceled -= m_Wrapper.m_InpActionsCallbackInterface.OnPause;
            }
